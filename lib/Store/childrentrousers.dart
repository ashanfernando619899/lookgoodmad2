...
class Childrentrousers extends StatefulWidget {
  @override
  _Childrentrousers createState() => _Childrentrousers();
}


class _Childrentrousers extends State<Childrentrousers> {
  @override
        ...
        body: CustomScrollView(
          slivers: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: Firestore.instance.collection("itemschildrentrousers").limit(15).orderBy("publishedDate", descending: true).snapshots(),
                      ...
                      Container(
                        ...
                        child: Center(
                          child: Column(
                            ...
                            children: [
                              Text(
                                "new" , style: TextStyle(fontSize: 15.0, color: Colors.white, fontWeight: FontWeight.normal),
                              ),
