...
class Womenshoes extends StatefulWidget {
  @override
  _Womenshoes createState() => _Womenshoes();
}


class _Womenshoes extends State<Womenshoes> {
  @override
        ...
        body: CustomScrollView(
          slivers: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: Firestore.instance.collection("itemswomenshoes").limit(15).orderBy("publishedDate", descending: true).snapshots(),
