...
class Menhats extends StatefulWidget {
  @override
  _Menhats createState() => _Menhats();
}


class _Menhats extends State<Menhats> {
  @override
        ...
        body: CustomScrollView(
          slivers: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: Firestore.instance.collection("itemsmenhats").limit(15).orderBy("publishedDate", descending: true).snapshots(),
