...
class Womentshirt extends StatefulWidget {
  @override
  _Womentshirt createState() => _Womentshirt();
}


class _Womentshirt extends State<Womentshirt> {
  @override
        ...
        body: CustomScrollView(
          slivers: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: Firestore.instance.collection("itemswomentshirt").limit(15).orderBy("publishedDate", descending: true).snapshots(),
