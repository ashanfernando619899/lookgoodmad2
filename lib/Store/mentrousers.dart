...
class Mentrousers extends StatefulWidget {
  @override
  _Mentrousers createState() => _Mentrousers();
}


class _Mentrousers extends State<Mentrousers> {
  @override
        ...
        body: CustomScrollView(
          slivers: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: Firestore.instance.collection("itemsmentrousers").limit(15).orderBy("publishedDate", descending: true).snapshots(),
