...
class Womentrousers extends StatefulWidget {
  @override
  _Womentrousers createState() => _Womentrousers();
}


class _Womentrousers extends State<Womentrousers> {
  @override
        ...
        body: CustomScrollView(
          slivers: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: Firestore.instance.collection("itemswomentrousers").limit(15).orderBy("publishedDate", descending: true).snapshots(),
