...
class Childrentshirt extends StatefulWidget {
  @override
  _Childrentshirt createState() => _Childrentshirt();
}


class _Childrentshirt extends State<Childrentshirt> {
  @override
        ...
        body: CustomScrollView(
          slivers: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: Firestore.instance.collection("itemschildrentshirts").limit(15).orderBy("publishedDate", descending: true).snapshots(),
