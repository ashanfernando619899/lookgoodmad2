...
class Womenhats extends StatefulWidget {
  @override
  _Womenhats createState() => _Womenhats();
}


class _Womenhats extends State<Womenhats> {
  @override
        ...
        body: CustomScrollView(
          slivers: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: Firestore.instance.collection("itemswomenhats").limit(15).orderBy("publishedDate", descending: true).snapshots(),
