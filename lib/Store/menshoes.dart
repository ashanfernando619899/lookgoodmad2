...
class Menshoes extends StatefulWidget {
  @override
  _Menshoes createState() => _Menshoes();
}


class _Menshoes extends State<Menshoes> {
  @override
        ...
        body: CustomScrollView(
          slivers: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: Firestore.instance.collection("itemsmenshoes").limit(15).orderBy("publishedDate", descending: true).snapshots(),
