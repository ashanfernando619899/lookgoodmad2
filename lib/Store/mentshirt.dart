...
class Mentshirt extends StatefulWidget {
  @override
  _Mentshirt createState() => _Mentshirt();
}


class _Mentshirt extends State<Mentshirt> {
  @override
        ...
        body: CustomScrollView(
          slivers: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: Firestore.instance.collection("itemsmen").limit(15).orderBy("publishedDate", descending: true).snapshots(),
