...
class Childrenshoes extends StatefulWidget {
  @override
  _Childrenshoes createState() => _Childrenshoes();
}


class _Childrenshoes extends State<Childrenshoes> {
  @override
        ...
        body: CustomScrollView(
          slivers: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: Firestore.instance.collection("itemschildrenshoes").limit(15).orderBy("publishedDate", descending: true).snapshots(),
